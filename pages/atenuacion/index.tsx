...
import { amplify } from 'lib/array'
import Slider from '@material-ui/core/Slider';
import VolumeDown from '@material-ui/icons/VolumeDown';
import VolumeUp from '@material-ui/icons/VolumeUp'; import Navbar from 'components/navbar'
import audioBufferToWav from 'lib/audio_to_wav'

export default function Atenuacion() {
    ...
    const [input, set_input] = useState(0.5)
    ...
    const sumSignal = () => {
        ...
        var rawSum = amplify(raw_signal_1, input)
    ...
    if (signal != null && suma == null) { sumSignal(); }
    return (
        <div style={{ backgroundColor: "#212121" }} className="text-center flex items-center justify-center h-screen">
            ...
            <div className="w-full flex">
                ...
                <h1 className="text-white text-2xl  mx-0 my-auto">*</h1>

                <div className="w-6/12 mx-0 my-auto">
                    <h1 className="text-white text-2xl">Numero de veces a atenuar</h1>
                    <div className="flex p-20 text-white">
                        <VolumeDown />
                        <Slider className="mx-4" value={input} color="secondary" valueLabelDisplay="auto" step={.1} max={1} min={0.1} onChange={handleChange} aria-labelledby="continuous-slider" />
                        <VolumeUp />
                    </div>
                </div>
            </div>
