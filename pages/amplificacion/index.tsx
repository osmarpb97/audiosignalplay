        ...
        <div style={{ backgroundColor: "#212121" }} className="text-center flex items-center justify-center h-screen">
            ...
            <div className="w-full flex">
                ...
                <div className="w-6/12 mx-0 my-auto">
                    <h1 className="text-white text-2xl">Numero de veces a amplificar</h1>
                    <div className="flex p-20 text-white">
                        <VolumeDown />
                        <Slider className="mx-4" value={input} color="secondary" valueLabelDisplay="auto" step={1} max={10} min={1} onChange={handleChange} aria-labelledby="continuous-slider" />
                        <VolumeUp />
                    </div>
                </div>
            </div>
